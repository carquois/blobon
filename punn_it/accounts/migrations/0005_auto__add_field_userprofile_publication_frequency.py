...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.publication_frequency'
        db.add_column('accounts_userprofile', 'publication_frequency',
                      self.gf('django.db.models.fields.CharField')(default='30m', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.publication_frequency'
        db.delete_column('accounts_userprofile', 'publication_frequency')
