...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.created_with_provider'
        db.add_column('accounts_userprofile', 'created_with_provider',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.created_with_provider'
        db.delete_column('accounts_userprofile', 'created_with_provider')
