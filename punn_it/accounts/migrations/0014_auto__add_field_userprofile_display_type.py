...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.display_type'
        db.add_column('accounts_userprofile', 'display_type',
                      self.gf('django.db.models.fields.CharField')(default='th', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.display_type'
        db.delete_column('accounts_userprofile', 'display_type')
