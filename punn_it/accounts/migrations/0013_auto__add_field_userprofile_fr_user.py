...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.fr_user'
        db.add_column('accounts_userprofile', 'fr_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='french_related_user', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.fr_user'
        db.delete_column('accounts_userprofile', 'fr_user_id')
