...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.pro_user'
        db.add_column('accounts_userprofile', 'pro_user',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.pro_user'
        db.delete_column('accounts_userprofile', 'pro_user')
