...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.facebook_link'
        db.add_column('accounts_userprofile', 'facebook_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.twitter_link'
        db.add_column('accounts_userprofile', 'twitter_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.facebook_link'
        db.delete_column('accounts_userprofile', 'facebook_link')

        # Deleting field 'UserProfile.twitter_link'
        db.delete_column('accounts_userprofile', 'twitter_link')
