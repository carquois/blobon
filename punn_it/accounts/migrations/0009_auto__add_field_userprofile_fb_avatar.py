...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.fb_avatar'
        db.add_column('accounts_userprofile', 'fb_avatar',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.fb_avatar'
        db.delete_column('accounts_userprofile', 'fb_avatar')
