...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('posts_post', 'blog',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Blog'], null=True),
                      keep_default=False)

        # Deleting field 'BlogPost.blog'
        db.delete_column('posts_blogpost', 'blog_id')


    def backwards(self, orm):
        # Deleting field 'Post.blog'
        db.delete_column('posts_post', 'blog_id')

        # Adding field 'BlogPost.blog'
        db.add_column('posts_blogpost', 'blog',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Blog'], null=True),
                      keep_default=False)
