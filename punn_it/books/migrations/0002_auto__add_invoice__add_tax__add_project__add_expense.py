...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('books_invoice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Client'])),
            ('date_of_issue', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('invoice_number', self.gf('django.db.models.fields.PositiveIntegerField')(blank=True)),
            ('terms', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ...
        db.send_create_signal('books', ['Invoice'])

        # Adding model 'Tax'
        db.create_table('books_tax', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('rate', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('number', self.gf('django.db.models.fields.PositiveIntegerField')(blank=True)),
            ('compound_tax', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('books', ['Tax'])

        # Adding model 'Project'
        db.create_table('books_project', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Client'])),
            ('rate_per_hour', self.gf('django.db.models.fields.PositiveIntegerField')(blank=True)),
        ))
        db.send_create_signal('books', ['Project'])

        # Adding model 'Expense'
        db.create_table('books_expense', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('books', ['Expense'])


    def backwards(self, orm):
        # Deleting model 'Invoice'
        db.delete_table('books_invoice')

        # Deleting model 'Tax'
        db.delete_table('books_tax')

        # Deleting model 'Project'
        db.delete_table('books_project')

        # Deleting model 'Expense'
        db.delete_table('books_expense')
