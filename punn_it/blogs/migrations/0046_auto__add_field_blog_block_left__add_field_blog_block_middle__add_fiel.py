...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Blog.block_middle'
        db.add_column('blogs_blog', 'block_middle',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Blog.block_about'
        db.add_column('blogs_blog', 'block_about',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)
        ...
        # Changing field 'Blog.block_navbar'
        db.alter_column('blogs_blog', 'block_navbar', self.gf('django.db.models.fields.TextField')(max_length=10000))

        # Changing field 'Blog.block_infoletter'
        db.alter_column('blogs_blog', 'block_infoletter', self.gf('django.db.models.fields.TextField')(max_length=10000))

        # Changing field 'Blog.block_elsewhere'
        db.alter_column('blogs_blog', 'block_elsewhere', self.gf('django.db.models.fields.TextField')(max_length=10000))

        # Changing field 'Blog.block_archive'
        db.alter_column('blogs_blog', 'block_archive', self.gf('django.db.models.fields.TextField')(max_length=10000))

    def backwards(self, orm):
        # Deleting field 'Blog.block_left'
        db.delete_column('blogs_blog', 'block_left')

        # Deleting field 'Blog.block_middle'
        db.delete_column('blogs_blog', 'block_middle')

        # Deleting field 'Blog.block_right'
        db.delete_column('blogs_blog', 'block_right')

        # Deleting field 'Blog.block_about'
        db.delete_column('blogs_blog', 'block_about')
        ...
        # Changing field 'Blog.block_navbar'
        db.alter_column('blogs_blog', 'block_navbar', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Blog.block_infoletter'
        db.alter_column('blogs_blog', 'block_infoletter', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Blog.block_elsewhere'
        db.alter_column('blogs_blog', 'block_elsewhere', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Blog.block_archive'
        db.alter_column('blogs_blog', 'block_archive', self.gf('django.db.models.fields.CharField')(max_length=500))
    ...
    models = {
        ...
        'blogs.blog': {
            ...
            'block_about': ('django.db.models.fields.TextField', [], {'max_length': '10000', 'blank': 'True'}),
            'block_all': ('django.db.models.fields.TextField', [], {'max_length': '10000', 'blank': 'True'}),
            'block_archive': ('django.db.models.fields.TextField', [], {'max_length': '10000', 'blank': 'True'}),
            'block_elsewhere': ('django.db.models.fields.TextField', [], {'max_length': '10000', 'blank': 'True'}),
            'block_footer': ('django.db.models.fields.TextField', [], {'max_length': '10000', 'blank': 'True'}),
            'block_infoletter': ('django.db.models.fields.TextField', [], {'max_length': '10000', 'blank': 'True'}),
