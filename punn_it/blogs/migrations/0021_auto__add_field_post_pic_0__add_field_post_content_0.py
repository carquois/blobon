...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.pic_0'
        db.add_column('blogs_post', 'pic_0',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.content_0'
        db.add_column('blogs_post', 'content_0',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.pic_0'
        db.delete_column('blogs_post', 'pic_0')

        # Deleting field 'Post.content_0'
        db.delete_column('blogs_post', 'content_0')
