...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.translated_content'
        db.add_column('blogs_post', 'translated_content',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Post.is_ready'
        db.add_column('blogs_post', 'is_ready',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.translated_content'
        db.delete_column('blogs_post', 'translated_content')

        # Deleting field 'Post.is_ready'
        db.delete_column('blogs_post', 'is_ready')
