...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.comment_status'
        db.add_column('blogs_comment', 'comment_status',
                      self.gf('django.db.models.fields.CharField')(default='pe', max_length=2),
                      keep_default=False)

        # Adding field 'Blog.moderator_email'
        db.add_column('blogs_blog', 'moderator_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.comment_status'
        db.delete_column('blogs_comment', 'comment_status')

        # Deleting field 'Blog.moderator_email'
        db.delete_column('blogs_blog', 'moderator_email')
    ...
    models = {
        ...
        'blogs.blog': {
            ...
            'moderator_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
