...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blogs_post', 'status', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):

        # Changing field 'Post.status'
        db.alter_column('blogs_post', 'status', self.gf('django.db.models.fields.CharField')(max_length=2))
