...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.pic_2'
        db.add_column('blogs_post', 'pic_2',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.pic_3'
        db.add_column('blogs_post', 'pic_3',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.pic_4'
        db.add_column('blogs_post', 'pic_4',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.pic_5'
        db.add_column('blogs_post', 'pic_5',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.pic_6'
        db.add_column('blogs_post', 'pic_6',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.pic_2'
        db.delete_column('blogs_post', 'pic_2')

        # Deleting field 'Post.pic_3'
        db.delete_column('blogs_post', 'pic_3')

        # Deleting field 'Post.pic_4'
        db.delete_column('blogs_post', 'pic_4')

        # Deleting field 'Post.pic_5'
        db.delete_column('blogs_post', 'pic_5')

        # Deleting field 'Post.pic_6'
        db.delete_column('blogs_post', 'pic_6')
