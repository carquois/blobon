...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Blog.main_image'
        db.delete_column('blogs_blog', 'main_image')

        # Adding field 'Blog.header_image'
        db.add_column('blogs_blog', 'header_image',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Blog.language'
        db.add_column('blogs_blog', 'language',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Blog.main_image'
        db.add_column('blogs_blog', 'main_image',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Blog.header_image'
        db.delete_column('blogs_blog', 'header_image')

        # Deleting field 'Blog.language'
        db.delete_column('blogs_blog', 'language')
