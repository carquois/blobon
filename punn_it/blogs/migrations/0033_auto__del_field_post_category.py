...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('blogs_post', 'category_id')

        # Adding M2M table for field category on 'Post'
        db.create_table('blogs_post_category', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm['blogs.post'], null=False)),
            ('category', models.ForeignKey(orm['blogs.category'], null=False))
        ))
        db.create_unique('blogs_post_category', ['post_id', 'category_id'])


    def backwards(self, orm):
        # Adding field 'Post.category'
        db.add_column('blogs_post', 'category',
        ...
        db.delete_table('blogs_post_category')
