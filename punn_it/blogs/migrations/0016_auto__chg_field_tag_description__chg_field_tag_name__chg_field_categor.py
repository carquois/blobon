...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blogs_tag', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Tag.name'
        db.alter_column('blogs_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))

        # Changing field 'Category.description'
        db.alter_column('blogs_category', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Category.name'
        db.alter_column('blogs_category', 'name', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Category.name'
        raise RuntimeError("Cannot reverse this migration. 'Category.name' and its values cannot be restored.")
