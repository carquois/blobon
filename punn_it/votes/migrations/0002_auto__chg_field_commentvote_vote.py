...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CommentVote.vote'
        db.alter_column('votes_commentvote', 'vote', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'CommentVote.vote'
        db.alter_column('votes_commentvote', 'vote', self.gf('django.db.models.fields.CharField')(max_length=1))
