...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.punn'
        db.alter_column('images_image', 'punn_id', self.gf('django.db.models.fields.related.OneToOneField')(default='hey', to=orm['punns.Punn'], unique=True))
        # Adding unique constraint on 'Image', fields ['punn']
        db.create_unique('images_image', ['punn_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Image', fields ['punn']
        db.delete_unique('images_image', ['punn_id'])


        # Changing field 'Image.punn'
        db.alter_column('images_image', 'punn_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['punns.Punn'], null=True))
    ...
    models = {
        ...
        'images.image': {
            ...
            'punn': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['punns.Punn']", 'unique': 'True'})
        },
        'punns.punn': {
