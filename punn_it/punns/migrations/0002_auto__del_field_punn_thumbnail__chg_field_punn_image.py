...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Punn.thumbnail'
        db.delete_column('punns_punn', 'thumbnail')


        # Changing field 'Punn.image'
        db.alter_column('punns_punn', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Adding field 'Punn.thumbnail'
        db.add_column('punns_punn', 'thumbnail',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=300, blank=True),
                      keep_default=False)


        # Changing field 'Punn.image'
        db.alter_column('punns_punn', 'image', self.gf('django.db.models.fields.URLField')(default='', max_length=300))
