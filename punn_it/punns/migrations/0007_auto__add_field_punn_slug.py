...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Punn.slug'
        db.add_column('punns_punn', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Punn.slug'
        db.delete_column('punns_punn', 'slug')
    ...
    models = {
        ...
        'punns.punn': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '140', 'blank': 'True'}),
