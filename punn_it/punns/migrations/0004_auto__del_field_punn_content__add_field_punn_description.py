...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Punn.content'
        db.delete_column('punns_punn', 'content')

        # Adding field 'Punn.description'
        db.add_column('punns_punn', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Punn.content'
        db.add_column('punns_punn', 'content',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Deleting field 'Punn.description'
        db.delete_column('punns_punn', 'description')
