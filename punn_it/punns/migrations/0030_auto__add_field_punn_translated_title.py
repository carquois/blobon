...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Punn.translated_title'
        db.add_column('punns_punn', 'translated_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Punn.translated_title'
        db.delete_column('punns_punn', 'translated_title')
