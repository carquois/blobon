...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Punn.pub_date'
        db.alter_column('punns_punn', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # Changing field 'Punn.pub_date'
        db.alter_column('punns_punn', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
