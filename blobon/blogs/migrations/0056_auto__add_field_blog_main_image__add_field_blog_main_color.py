...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Blog.main_color'
        db.add_column('blogs_blog', 'main_color',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Blog.main_color'
        db.delete_column('blogs_blog', 'main_color')
    ...
    models = {
        ...
        'blogs.blog': {
            ...
            'main_color': ('django.db.models.fields.TextField', [], {'max_length': '10', 'blank': 'True'}),
