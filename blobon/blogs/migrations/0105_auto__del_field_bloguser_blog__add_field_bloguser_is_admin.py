...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlogUser.blog'
        db.delete_column('blogs_bloguser', 'blog_id')

        # Adding field 'BlogUser.is_admin'
        db.add_column('blogs_bloguser', 'is_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field blog_user on 'Blog'
        db.create_table('blogs_blog_blog_user', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blog', models.ForeignKey(orm['blogs.blog'], null=False)),
            ('bloguser', models.ForeignKey(orm['blogs.bloguser'], null=False))
        ))
        db.create_unique('blogs_blog_blog_user', ['blog_id', 'bloguser_id'])


    def backwards(self, orm):
        # Adding field 'BlogUser.blog'
        db.add_column('blogs_bloguser', 'blog',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='Blog_User', null=True, to=orm['blogs.Blog']),
                      keep_default=False)

        # Deleting field 'BlogUser.is_admin'
        db.delete_column('blogs_bloguser', 'is_admin')

        # Removing M2M table for field blog_user on 'Blog'
        db.delete_table('blogs_blog_blog_user')
    ...
    models = {
        ...
        'blogs.blog': {
            ...
            'blog_user': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['blogs.BlogUser']", 'null': 'True', 'blank': 'True'}),
