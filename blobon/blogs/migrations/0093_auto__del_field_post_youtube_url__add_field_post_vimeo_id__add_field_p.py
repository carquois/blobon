...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.youtube_url'
        db.delete_column('blogs_post', 'youtube_url')

        # Adding field 'Post.vimeo_id'
        db.add_column('blogs_post', 'vimeo_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.video_url'
        db.add_column('blogs_post', 'video_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Post.youtube_url'
        db.add_column('blogs_post', 'youtube_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=300, blank=True),
                      keep_default=False)

        # Deleting field 'Post.vimeo_id'
        db.delete_column('blogs_post', 'vimeo_id')

        # Deleting field 'Post.video_url'
        db.delete_column('blogs_post', 'video_url')
