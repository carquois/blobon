...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Blog.main_color'
        db.alter_column('blogs_blog', 'main_color', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Blog.main_color'
        db.alter_column('blogs_blog', 'main_color', self.gf('django.db.models.fields.TextField')(max_length=10))
