...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.fb_page_access_token'
        db.add_column('blogs_blog', 'fb_page_access_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=260, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.fb_page_access_token'
        db.delete_column('blogs_blog', 'fb_page_access_token')
