...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ModelField.custom_post'
        db.delete_column('blogs_modelfield', 'custom_post_id')

        # Adding field 'ModelField.model'
        db.add_column('blogs_modelfield', 'model',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Model'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ModelField.custom_post'
        db.add_column('blogs_modelfield', 'custom_post',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Model'], null=True),
                      keep_default=False)

        # Deleting field 'ModelField.model'
        db.delete_column('blogs_modelfield', 'model_id')
