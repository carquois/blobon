...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Blog.custom_domain'
        db.alter_column('blogs_blog', 'custom_domain', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'Blog.custom_domain'
        db.alter_column('blogs_blog', 'custom_domain', self.gf('django.db.models.fields.CharField')(default='', max_length=300))
