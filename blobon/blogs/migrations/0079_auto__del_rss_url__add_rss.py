...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Rss_url'
        db.delete_table('blogs_rss_url')

        # Adding model 'Rss'
        db.create_table('blogs_rss', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feed_url', self.gf('django.db.models.fields.URLField')(max_length=300, blank=True)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Blog_rss', null=True, to=orm['blogs.Blog'])),
        ))
        db.send_create_signal('blogs', ['Rss'])
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal('blogs', ['Rss_url'])

        # Deleting model 'Rss'
        db.delete_table('blogs_rss')
