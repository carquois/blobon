...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Menu'
        db.create_table('blogs_menu', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Blog_menu', null=True, to=orm['blogs.Blog'])),
        ))
        db.send_create_signal('blogs', ['Menu'])

        # Adding model 'MenuItem'
        db.create_table('blogs_menuitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('menu', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Menu'], null=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Page'], null=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Category'], null=True)),
            ('external_link', self.gf('django.db.models.fields.URLField')(max_length=140, blank=True)),
        ))
        db.send_create_signal('blogs', ['MenuItem'])


    def backwards(self, orm):
        # Deleting model 'Menu'
        db.delete_table('blogs_menu')

        # Deleting model 'MenuItem'
        db.delete_table('blogs_menuitem')
    ...
    models = {
        ...
        'blogs.menuitem': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blogs.Category']", 'null': 'True'}),
            ...
            'page': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blogs.Page']", 'null': 'True'}),
