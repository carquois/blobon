...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ModelFieldData.model_field'
        db.delete_column('blogs_modelfielddata', 'model_field_id')


    def backwards(self, orm):
        # Adding field 'ModelFieldData.model_field'
        db.add_column('blogs_modelfielddata', 'model_field',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.ModelField'], null=True),
                      keep_default=False)
