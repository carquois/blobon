...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blogs_blog', 'custom_domain',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.custom_domain'
        db.delete_column('blogs_blog', 'custom_domain')
    ...
    models = {
        ...
        'blogs.blog': {
            ...
            'custom_domain': ('django.db.models.fields.URLField', [], {'max_length': '300', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
