...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field bloguser on 'Blog'
        db.create_table('blogs_blog_bloguser', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blog', models.ForeignKey(orm['blogs.blog'], null=False)),
            ('bloguser', models.ForeignKey(orm['blogs.bloguser'], null=False))
        ))
        db.create_unique('blogs_blog_bloguser', ['blog_id', 'bloguser_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field bloguser on 'Blog'
        db.delete_table('blogs_blog_bloguser')
    ...
    models = {
        ...
        'blogs.blog': {
            ...
            'bloguser': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['blogs.BlogUser']", 'null': 'True', 'blank': 'True'}),
