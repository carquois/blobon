...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.cat_image_left'
        db.add_column('blogs_category', 'cat_image_left',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.cat_image_right'
        db.add_column('blogs_category', 'cat_image_right',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.cat_image_close'
        db.add_column('blogs_category', 'cat_image_close',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.cat_image_left'
        db.delete_column('blogs_category', 'cat_image_left')

        # Deleting field 'Category.cat_image_right'
        db.delete_column('blogs_category', 'cat_image_right')

        # Deleting field 'Category.cat_image_close'
        db.delete_column('blogs_category', 'cat_image_close')
