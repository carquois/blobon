...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Info_email.frequency'
        db.add_column('blogs_info_email', 'frequency',
                      self.gf('django.db.models.fields.CharField')(default='We', max_length=2, null=True),
                      keep_default=False)

        # Adding field 'Info_email.subscribers'
        db.add_column('blogs_info_email', 'subscribers',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=2, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Info_email.frequency'
        db.delete_column('blogs_info_email', 'frequency')

        # Deleting field 'Info_email.subscribers'
        db.delete_column('blogs_info_email', 'subscribers')
