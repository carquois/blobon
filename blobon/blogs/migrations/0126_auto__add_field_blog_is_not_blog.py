...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.is_not_blog'
        db.add_column('blogs_blog', 'is_not_blog',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.is_not_blog'
        db.delete_column('blogs_blog', 'is_not_blog')
    ...
    models = {
        ...
        'blogs.blog': {
            ...
            'is_not_blog': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
