...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Info_email.subject'
        db.add_column('blogs_info_email', 'subject',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=100, blank=True),
                      keep_default=False)


        # Changing field 'Info_email.name'
        db.alter_column('blogs_info_email', 'name', self.gf('django.db.models.fields.CharField')(max_length=140))

    def backwards(self, orm):
        # Deleting field 'Info_email.subject'
        db.delete_column('blogs_info_email', 'subject')


        # Changing field 'Info_email.name'
        db.alter_column('blogs_info_email', 'name', self.gf('django.db.models.fields.TextField')(max_length=100))
