...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelField.rank'
        db.add_column('blogs_modelfield', 'rank',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=2),
                      keep_default=False)


        # Changing field 'ModelField.post_type'
        db.alter_column('blogs_modelfield', 'post_type', self.gf('django.db.models.fields.CharField')(max_length=40))
        # Adding field 'ModelFieldData.onetofive'
        db.add_column('blogs_modelfielddata', 'onetofive',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ModelFieldData.positiveinteger'
        db.add_column('blogs_modelfielddata', 'positiveinteger',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ModelFieldData.dateauto'
        db.add_column('blogs_modelfielddata', 'dateauto',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ModelFieldData.longtext'
        db.add_column('blogs_modelfielddata', 'longtext',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ModelFieldData.nullboolean'
        db.add_column('blogs_modelfielddata', 'nullboolean',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ModelFieldData.price'
        db.add_column('blogs_modelfielddata', 'price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelField.rank'
        db.delete_column('blogs_modelfield', 'rank')


        # Changing field 'ModelField.post_type'
        db.alter_column('blogs_modelfield', 'post_type', self.gf('django.db.models.fields.CharField')(max_length=10))
        # Deleting field 'ModelFieldData.onetofive'
        db.delete_column('blogs_modelfielddata', 'onetofive')

        # Deleting field 'ModelFieldData.positiveinteger'
        db.delete_column('blogs_modelfielddata', 'positiveinteger')

        # Deleting field 'ModelFieldData.dateauto'
        db.delete_column('blogs_modelfielddata', 'dateauto')

        # Deleting field 'ModelFieldData.longtext'
        db.delete_column('blogs_modelfielddata', 'longtext')

        # Deleting field 'ModelFieldData.nullboolean'
        db.delete_column('blogs_modelfielddata', 'nullboolean')

        # Deleting field 'ModelFieldData.price'
        db.delete_column('blogs_modelfielddata', 'price')
    ...
    models = {
        ...
        'blogs.modelfielddata': {
            ...
            'dateauto': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
