...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.custom_post'
        db.add_column('blogs_post', 'custom_post',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.CustomPost'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Post.custom_post'
        db.delete_column('blogs_post', 'custom_post_id')
    ...
    models = {
        ...
        'blogs.custompost': {
            'Meta': {'object_name': 'CustomPost'},
            'blog': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'Custom_post'", 'null': 'True', 'to': "orm['blogs.Blog']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '60'})
        },
        'blogs.fieldcustompost': {
            'Meta': {'object_name': 'FieldCustomPost'},
            'custom_post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blogs.CustomPost']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'blogs.post': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'custom_post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blogs.CustomPost']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
