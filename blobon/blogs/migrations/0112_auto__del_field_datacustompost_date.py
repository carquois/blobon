...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DataCustomPost.date'
        db.delete_column('blogs_datacustompost', 'date')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DataCustomPost.date'
        raise RuntimeError("Cannot reverse this migration. 'DataCustomPost.date' and its values cannot be restored.")
