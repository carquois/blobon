...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.content_1'
        db.add_column('blogs_post', 'content_1',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Post.content_2'
        db.add_column('blogs_post', 'content_2',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Post.content_3'
        db.add_column('blogs_post', 'content_3',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Post.content_4'
        db.add_column('blogs_post', 'content_4',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Post.content_5'
        db.add_column('blogs_post', 'content_5',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Post.content_6'
        db.add_column('blogs_post', 'content_6',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.content_1'
        db.delete_column('blogs_post', 'content_1')

        # Deleting field 'Post.content_2'
        db.delete_column('blogs_post', 'content_2')

        # Deleting field 'Post.content_3'
        db.delete_column('blogs_post', 'content_3')

        # Deleting field 'Post.content_4'
        db.delete_column('blogs_post', 'content_4')

        # Deleting field 'Post.content_5'
        db.delete_column('blogs_post', 'content_5')

        # Deleting field 'Post.content_6'
        db.delete_column('blogs_post', 'content_6')
