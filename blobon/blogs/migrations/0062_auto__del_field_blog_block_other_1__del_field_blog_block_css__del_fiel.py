...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Blog.block_other_1'
        db.delete_column('blogs_blog', 'block_other_1')

        # Deleting field 'Blog.block_css'
        db.delete_column('blogs_blog', 'block_css')

        # Deleting field 'Blog.block_middle'
        db.delete_column('blogs_blog', 'block_middle')

        # Deleting field 'Blog.block_other_2'
        db.delete_column('blogs_blog', 'block_other_2')

        # Deleting field 'Blog.block_other_3'
        db.delete_column('blogs_blog', 'block_other_3')
    ...
    def backwards(self, orm):
        # Adding field 'Blog.block_other_1'
        db.add_column('blogs_blog', 'block_other_1',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_css'
        db.add_column('blogs_blog', 'block_css',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Blog.block_other_2'
        db.add_column('blogs_blog', 'block_other_2',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_other_3'
        db.add_column('blogs_blog', 'block_other_3',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)
