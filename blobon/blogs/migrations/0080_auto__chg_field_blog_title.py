...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blogs_blog', 'title', self.gf('django.db.models.fields.CharField')(max_length=240))

    def backwards(self, orm):

        # Changing field 'Blog.title'
        db.alter_column('blogs_blog', 'title', self.gf('django.db.models.fields.CharField')(max_length=140))
