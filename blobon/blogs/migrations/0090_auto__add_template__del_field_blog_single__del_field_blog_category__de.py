...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blogs_template', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('base', self.gf('django.db.models.fields.TextField')(max_length=10000, blank=True)),
            ('single', self.gf('django.db.models.fields.TextField')(max_length=10000, blank=True)),
            ('category', self.gf('django.db.models.fields.TextField')(max_length=10000, blank=True)),
        ))
        db.send_create_signal('blogs', ['Template'])
        ...
        # Adding field 'Blog.template'
        db.add_column('blogs_blog', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Template'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Template'
        db.delete_table('blogs_template')
        ...
        # Deleting field 'Blog.template'
        db.delete_column('blogs_blog', 'template_id')
