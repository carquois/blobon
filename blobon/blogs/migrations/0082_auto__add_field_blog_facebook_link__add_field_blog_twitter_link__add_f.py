...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.facebook_link'
        db.add_column('blogs_blog', 'facebook_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Blog.twitter_link'
        db.add_column('blogs_blog', 'twitter_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Blog.twitter_oauth_token'
        db.add_column('blogs_blog', 'twitter_oauth_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Blog.twitter_oauth_token_secret'
        db.add_column('blogs_blog', 'twitter_oauth_token_secret',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.facebook_link'
        db.delete_column('blogs_blog', 'facebook_link')

        # Deleting field 'Blog.twitter_link'
        db.delete_column('blogs_blog', 'twitter_link')

        # Deleting field 'Blog.twitter_oauth_token'
        db.delete_column('blogs_blog', 'twitter_oauth_token')

        # Deleting field 'Blog.twitter_oauth_token_secret'
        db.delete_column('blogs_blog', 'twitter_oauth_token_secret')
