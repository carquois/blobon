...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Blog.block_all'
        db.delete_column('blogs_blog', 'block_all')

        # Deleting field 'Blog.block_infoletter'
        db.delete_column('blogs_blog', 'block_infoletter')

        # Deleting field 'Blog.block_elsewhere'
        db.delete_column('blogs_blog', 'block_elsewhere')

        # Deleting field 'Blog.block_archive'
        db.delete_column('blogs_blog', 'block_archive')
    ...
    def backwards(self, orm):
        # Adding field 'Blog.block_all'
        db.add_column('blogs_blog', 'block_all',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_infoletter'
        db.add_column('blogs_blog', 'block_infoletter',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_elsewhere'
        db.add_column('blogs_blog', 'block_elsewhere',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_archive'
        db.add_column('blogs_blog', 'block_archive',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)
