...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Menu.is_main'
        db.add_column('blogs_menu', 'is_main',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MenuItem.position'
        db.add_column('blogs_menuitem', 'position',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Menu.is_main'
        db.delete_column('blogs_menu', 'is_main')

        # Deleting field 'MenuItem.position'
        db.delete_column('blogs_menuitem', 'position')
