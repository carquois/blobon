...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.vimeo_thumb_url'
        db.add_column('blogs_post', 'vimeo_thumb_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.vimeo_thumb_url'
        db.delete_column('blogs_post', 'vimeo_thumb_url')
