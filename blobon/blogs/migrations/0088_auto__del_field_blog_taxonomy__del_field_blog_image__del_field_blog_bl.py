...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Blog.taxonomy'
        db.delete_column('blogs_blog', 'taxonomy')

        # Deleting field 'Blog.image'
        db.delete_column('blogs_blog', 'image')

        # Deleting field 'Blog.block_single_left'
        db.delete_column('blogs_blog', 'block_single_left')

        # Deleting field 'Blog.header'
        db.delete_column('blogs_blog', 'header')

        # Deleting field 'Blog.block_left'
        db.delete_column('blogs_blog', 'block_left')

        # Deleting field 'Blog.sidebar'
        db.delete_column('blogs_blog', 'sidebar')

        # Deleting field 'Blog.style'
        db.delete_column('blogs_blog', 'style')

        # Deleting field 'Blog.block_right'
        db.delete_column('blogs_blog', 'block_right')

        # Deleting field 'Blog.block_subscribe_button'
        db.delete_column('blogs_blog', 'block_subscribe_button')

        # Deleting field 'Blog.head'
        db.delete_column('blogs_blog', 'head')

        # Deleting field 'Blog.block_title'
        db.delete_column('blogs_blog', 'block_title')

        # Deleting field 'Blog.has_js'
        db.delete_column('blogs_blog', 'has_js')

        # Deleting field 'Blog.block_subscribe_text'
        db.delete_column('blogs_blog', 'block_subscribe_text')

        # Deleting field 'Blog.tag'
        db.delete_column('blogs_blog', 'tag')

        # Deleting field 'Blog.block_right_bottom'
        db.delete_column('blogs_blog', 'block_right_bottom')

        # Deleting field 'Blog.page'
        db.delete_column('blogs_blog', 'page')

        # Deleting field 'Blog.block_right_top'
        db.delete_column('blogs_blog', 'block_right_top')

        # Deleting field 'Blog.has_bootstrap'
        db.delete_column('blogs_blog', 'has_bootstrap')

        # Deleting field 'Blog.block_right_middle_1'
        db.delete_column('blogs_blog', 'block_right_middle_1')

        # Deleting field 'Blog.single'
        db.delete_column('blogs_blog', 'single')

        # Deleting field 'Blog.block_right_middle_2'
        db.delete_column('blogs_blog', 'block_right_middle_2')

        # Deleting field 'Blog.home'
        db.delete_column('blogs_blog', 'home')

        # Deleting field 'Blog.archive'
        db.delete_column('blogs_blog', 'archive')

        # Deleting field 'Blog.not_found_page'
        db.delete_column('blogs_blog', 'not_found_page')

        # Deleting field 'Blog.category'
        db.delete_column('blogs_blog', 'category')

        # Deleting field 'Blog.index'
        db.delete_column('blogs_blog', 'index')

        # Deleting field 'Blog.block_footer'
        db.delete_column('blogs_blog', 'block_footer')

        # Deleting field 'Blog.author'
        db.delete_column('blogs_blog', 'author')

        # Deleting field 'Blog.charset'
        db.delete_column('blogs_blog', 'charset')

        # Deleting field 'Blog.block_header'
        db.delete_column('blogs_blog', 'block_header')

        # Deleting field 'Blog.comments'
        db.delete_column('blogs_blog', 'comments')

        # Deleting field 'Blog.content'
        db.delete_column('blogs_blog', 'content')

        # Deleting field 'Blog.attachment'
        db.delete_column('blogs_blog', 'attachment')

        # Deleting field 'Blog.sidebar_footer'
        db.delete_column('blogs_blog', 'sidebar_footer')

        # Deleting field 'Blog.block_navbar'
        db.delete_column('blogs_blog', 'block_navbar')

        # Deleting field 'Blog.date'
        db.delete_column('blogs_blog', 'date')

        # Deleting field 'Blog.search'
        db.delete_column('blogs_blog', 'search')

        # Deleting field 'Blog.footer'
        db.delete_column('blogs_blog', 'footer')

        # Deleting field 'Blog.front_page'
        db.delete_column('blogs_blog', 'front_page')


    def backwards(self, orm):
        # Adding field 'Blog.taxonomy'
        db.add_column('blogs_blog', 'taxonomy',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.image'
        db.add_column('blogs_blog', 'image',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_single_left'
        db.add_column('blogs_blog', 'block_single_left',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.header'
        db.add_column('blogs_blog', 'header',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_left'
        db.add_column('blogs_blog', 'block_left',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.sidebar'
        db.add_column('blogs_blog', 'sidebar',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.style'
        db.add_column('blogs_blog', 'style',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_right'
        db.add_column('blogs_blog', 'block_right',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Blog.head'
        db.add_column('blogs_blog', 'head',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_title'
        db.add_column('blogs_blog', 'block_title',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.has_js'
        db.add_column('blogs_blog', 'has_js',
        ...
        # Adding field 'Blog.tag'
        db.add_column('blogs_blog', 'tag',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_right_bottom'
        db.add_column('blogs_blog', 'block_right_bottom',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.page'
        db.add_column('blogs_blog', 'page',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_right_top'
        db.add_column('blogs_blog', 'block_right_top',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.has_bootstrap'
        db.add_column('blogs_blog', 'has_bootstrap',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Blog.block_right_middle_1'
        db.add_column('blogs_blog', 'block_right_middle_1',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Blog.block_right_middle_2'
        db.add_column('blogs_blog', 'block_right_middle_2',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.home'
        db.add_column('blogs_blog', 'home',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.archive'
        db.add_column('blogs_blog', 'archive',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.not_found_page'
        db.add_column('blogs_blog', 'not_found_page',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Blog.index'
        db.add_column('blogs_blog', 'index',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_footer'
        db.add_column('blogs_blog', 'block_footer',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.author'
        db.add_column('blogs_blog', 'author',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.charset'
        db.add_column('blogs_blog', 'charset',
                      self.gf('django.db.models.fields.CharField')(default='utf-8', max_length=20),
                      keep_default=False)

        # Adding field 'Blog.block_header'
        db.add_column('blogs_blog', 'block_header',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.comments'
        db.add_column('blogs_blog', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.content'
        db.add_column('blogs_blog', 'content',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.attachment'
        db.add_column('blogs_blog', 'attachment',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.sidebar_footer'
        db.add_column('blogs_blog', 'sidebar_footer',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.block_navbar'
        db.add_column('blogs_blog', 'block_navbar',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.date'
        db.add_column('blogs_blog', 'date',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.search'
        db.add_column('blogs_blog', 'search',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.footer'
        db.add_column('blogs_blog', 'footer',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Adding field 'Blog.front_page'
        db.add_column('blogs_blog', 'front_page',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)
