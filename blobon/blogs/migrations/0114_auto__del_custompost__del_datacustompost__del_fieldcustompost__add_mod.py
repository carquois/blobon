...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CustomPost'
        db.delete_table('blogs_custompost')

        # Deleting model 'DataCustomPost'
        db.delete_table('blogs_datacustompost')

        # Deleting model 'FieldCustomPost'
        db.delete_table('blogs_fieldcustompost')

        # Adding model 'Model'
        db.create_table('blogs_model', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Custom_post', null=True, to=orm['blogs.Blog'])),
        ))
        db.send_create_signal('blogs', ['Model'])

        # Adding model 'ModelData'
        db.create_table('blogs_modeldata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Model'], null=True)),
        ))
        db.send_create_signal('blogs', ['ModelData'])

        # Adding model 'ModelField'
        db.create_table('blogs_modelfield', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('custom_post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Model'], null=True)),
            ('post_type', self.gf('django.db.models.fields.CharField')(default='Text', max_length=10)),
        ))
        db.send_create_signal('blogs', ['ModelField'])

        # Adding model 'ModelFieldData'
        db.create_table('blogs_modelfielddata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model_data', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.ModelData'], null=True)),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Model'], null=True)),
            ('model_field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.ModelField'], null=True)),
            ...
            ('url', self.gf('django.db.models.fields.URLField')(max_length=140, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('blogs', ['ModelFieldData'])


        # Changing field 'Post.custom_post'
        db.alter_column('blogs_post', 'custom_post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Model'], null=True))

    def backwards(self, orm):
        # Adding model 'CustomPost'
        db.create_table('blogs_custompost', (
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Custom_post', null=True, to=orm['blogs.Blog'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal('blogs', ['CustomPost'])

        # Adding model 'DataCustomPost'
        db.create_table('blogs_datacustompost', (
            ('url', self.gf('django.db.models.fields.URLField')(max_length=140, blank=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=140, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.FieldCustomPost'], null=True)),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=100)),
        ))
        db.send_create_signal('blogs', ['DataCustomPost'])

        # Adding model 'FieldCustomPost'
        db.create_table('blogs_fieldcustompost', (
            ('custom_post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.CustomPost'], null=True)),
            ('post_type', self.gf('django.db.models.fields.CharField')(default='Text', max_length=10)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('blogs', ['FieldCustomPost'])

        # Deleting model 'Model'
        db.delete_table('blogs_model')

        # Deleting model 'ModelData'
        db.delete_table('blogs_modeldata')

        # Deleting model 'ModelField'
        db.delete_table('blogs_modelfield')

        # Deleting model 'ModelFieldData'
        db.delete_table('blogs_modelfielddata')


        # Changing field 'Post.custom_post'
        db.alter_column('blogs_post', 'custom_post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.CustomPost'], null=True))
    ...
    models = {
        ...
        'blogs.modelfield': {
            ...
            'custom_post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blogs.Model']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post_type': ('django.db.models.fields.CharField', [], {'default': "'Text'", 'max_length': '10'})
        },
