...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Info_email.content'
        db.delete_column('blogs_info_email', 'content')

        # Adding field 'Info_email.message'
        db.add_column('blogs_info_email', 'message',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Info_email.content'
        db.add_column('blogs_info_email', 'content',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)

        # Deleting field 'Info_email.message'
        db.delete_column('blogs_info_email', 'message')
