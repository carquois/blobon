...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.analytics_account'
        db.add_column('blogs_blog', 'analytics_account',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Blog.exclusion_start'
        db.add_column('blogs_blog', 'exclusion_start',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)

        # Adding field 'Blog.exclusion_end'
        db.add_column('blogs_blog', 'exclusion_end',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)

        # Adding field 'Blog.frequency'
        db.add_column('blogs_blog', 'frequency',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.analytics_account'
        db.delete_column('blogs_blog', 'analytics_account')

        # Deleting field 'Blog.exclusion_start'
        db.delete_column('blogs_blog', 'exclusion_start')

        # Deleting field 'Blog.exclusion_end'
        db.delete_column('blogs_blog', 'exclusion_end')

        # Deleting field 'Blog.frequency'
        db.delete_column('blogs_blog', 'frequency')
    ...
    models = {
        ...
        'blogs.blog': {
            ...
            'main_color': ('django.db.models.fields.CharField', [], {'default': "'#ff7f00'", 'max_length': '10', 'blank': 'True'}),
