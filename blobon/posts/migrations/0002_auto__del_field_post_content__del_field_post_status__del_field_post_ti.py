...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('posts_post', 'status')

        # Deleting field 'Post.title'
        db.delete_column('posts_post', 'title')
    ...
    def backwards(self, orm):
        ...
        db.add_column('posts_post', 'content',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Post.status'
        raise RuntimeError("Cannot reverse this migration. 'Post.status' and its values cannot be restored.")
        # Adding field 'Post.title'
        db.add_column('posts_post', 'title',
