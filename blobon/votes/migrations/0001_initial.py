...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('votes_commentvote', (
        ...
        db.send_create_signal('votes', ['CommentVote'])

        # Adding model 'PunnVote'
        db.create_table('votes_punnvote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('punn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['punns.Punn'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('vote', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('votes', ['PunnVote'])


    def backwards(self, orm):
        # Deleting model 'CommentVote'
        db.delete_table('votes_commentvote')

        # Deleting model 'PunnVote'
        db.delete_table('votes_punnvote')
