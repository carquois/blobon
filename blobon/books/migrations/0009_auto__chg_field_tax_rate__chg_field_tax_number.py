...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tax.rate'
        db.alter_column('books_tax', 'rate', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=4))

        # Changing field 'Tax.number'
        db.alter_column('books_tax', 'number', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Tax.rate'
        db.alter_column('books_tax', 'rate', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Tax.number'
        db.alter_column('books_tax', 'number', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=4))
