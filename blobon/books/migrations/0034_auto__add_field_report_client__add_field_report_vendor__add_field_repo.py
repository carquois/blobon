...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.client'
        db.add_column('books_report', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['books.Client'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Report.vendor'
        db.add_column('books_report', 'vendor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['books.Vendor'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Report.category'
        db.add_column('books_report', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['books.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.client'
        db.delete_column('books_report', 'client_id')

        # Deleting field 'Report.vendor'
        db.delete_column('books_report', 'vendor_id')

        # Deleting field 'Report.category'
        db.delete_column('books_report', 'category_id')
    ...
    models = {
        ...
        'books.invoice': {
            ...
            'with_items': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'with_taxes': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        'books.item': {
