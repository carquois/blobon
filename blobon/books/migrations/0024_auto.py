...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field taxes on 'Expense'
        db.create_table('books_expense_taxes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('expense', models.ForeignKey(orm['books.expense'], null=False)),
            ('tax', models.ForeignKey(orm['books.tax'], null=False))
        ))
        db.create_unique('books_expense_taxes', ['expense_id', 'tax_id'])


    def backwards(self, orm):
        # Removing M2M table for field taxes on 'Expense'
        db.delete_table('books_expense_taxes')
