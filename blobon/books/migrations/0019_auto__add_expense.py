...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('books_expense', (
            ...
            ('vendor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Vendor'])),
    ...
    models = {
        ...
        'books.expense': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['books.Category']"}),
            ...
            'vendor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['books.Vendor']"})
        },
        'books.invoice': {
