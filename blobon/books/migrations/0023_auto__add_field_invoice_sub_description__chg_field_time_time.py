...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.sub_description'
        db.add_column('books_invoice', 'sub_description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=10000, blank=True),
                      keep_default=False)


        # Changing field 'Time.time'
        db.alter_column('books_time', 'time', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'Invoice.sub_description'
        db.delete_column('books_invoice', 'sub_description')


        # Changing field 'Time.time'
        db.alter_column('books_time', 'time', self.gf('django.db.models.fields.PositiveIntegerField')())
