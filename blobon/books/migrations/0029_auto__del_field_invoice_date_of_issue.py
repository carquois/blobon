...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Invoice.date_of_issue'
        raise RuntimeError("Cannot reverse this migration. 'Invoice.date_of_issue' and its values cannot be restored.")
