...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expense.notes'
        db.add_column('books_expense', 'notes',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Expense.date'
        db.alter_column('books_expense', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting field 'Expense.notes'
        db.delete_column('books_expense', 'notes')


        # Changing field 'Expense.date'
        db.alter_column('books_expense', 'date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'books.expense': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['books.Category']", 'blank': 'True'}),
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['books.Client']", 'blank': 'True'}),
            ...
            'vendor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['books.Vendor']", 'blank': 'True'})
        },
        'books.invoice': {
