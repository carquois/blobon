...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Time.invoice'
        db.add_column('books_time', 'invoice',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Invoice'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Time.invoice'
        db.delete_column('books_time', 'invoice_id')
