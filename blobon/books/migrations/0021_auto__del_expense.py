...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('books_expense', (
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Category'], blank=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
            ('vendor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Vendor'], blank=True)),
            ...
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Client'], blank=True)),
        ))
