...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('books_expense', (
            ...
            ('vendor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['books.Vendor'], null=True, blank=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['books.Client'], null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['books.Category'], null=True, blank=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('receipt', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
