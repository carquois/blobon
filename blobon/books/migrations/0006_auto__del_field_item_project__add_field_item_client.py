...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('books_item', 'project_id')

        # Adding field 'Item.client'
        db.add_column('books_item', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Client'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Item.project'
        db.add_column('books_item', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['books.Project'], null=True),
                      keep_default=False)

        # Deleting field 'Item.client'
        db.delete_column('books_item', 'client_id')
