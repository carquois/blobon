...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.end_date'
        db.alter_column('books_report', 'end_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Report.start_date'
        db.alter_column('books_report', 'start_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Report.end_date'
        db.alter_column('books_report', 'end_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Report.start_date'
        db.alter_column('books_report', 'start_date', self.gf('django.db.models.fields.DateField')())
