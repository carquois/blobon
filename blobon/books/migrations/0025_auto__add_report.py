...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Report'
        db.create_table('books_report', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('invoice', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('expense', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('taxes', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('timesheet', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('books', ['Report'])


    def backwards(self, orm):
        # Deleting model 'Report'
        db.delete_table('books_report')
