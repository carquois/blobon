...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Invoice.sub_terms'
        db.delete_column('books_invoice', 'sub_terms')

        # Adding field 'Invoice.sub_notes'
        db.add_column('books_invoice', 'sub_notes',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding field 'Invoice.paid_notes'
        db.add_column('books_invoice', 'paid_notes',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Invoice.sub_terms'
        db.add_column('books_invoice', 'sub_terms',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Deleting field 'Invoice.sub_notes'
        db.delete_column('books_invoice', 'sub_notes')

        # Deleting field 'Invoice.paid_notes'
        db.delete_column('books_invoice', 'paid_notes')
