...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('books_invoice', 'status',
                      self.gf('django.db.models.fields.CharField')(default='D', max_length=2, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.status'
        db.delete_column('books_invoice', 'status')
    ...
    models = {
        ...
        'books.invoice': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'D'", 'max_length': '2', 'null': 'True'}),
