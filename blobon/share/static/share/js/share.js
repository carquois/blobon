...
if (!((window._atc || {}).ver)) {
    var _atd = "www.addthis.com/",
        ...
        _atc = {
            ...
            cdn: 0,
            rsrcs: {
                bookmark: _atr + "static/r07/bookmark041.html",
                atimg: _atr + "static/r07/atimg041.html",
                countercss: _atr + "static/r07/counter014.css",
                counterIE67css: _atr + "static/r07/counterIE67004.css",
                counter: _atr + "static/r07/counter017.js",
                core: _atr + "static/r07/core126.js",
                ...
                contentcss: _atr + "static/r07/content008.css",
                contentjs: _atr + "static/r07/content022.js",
                layersjs: _atr + "static/r07/layers044.js",
                layerscss: _atr + "static/r07/layers035.css",
                layersiecss: _atr + "static/r07/layersIE6007.css",
                ...
                authjs: _atr + "static/r07/auth016.js",
                peekaboocss: _atr + "static/r07/peekaboo002.css",
                overlayjs: _atr + "static/r07/overlay005.js",
                widget32css: _atr + "static/r07/widgetbig059.css",
                widget20css: _atr + "static/r07/widgetmed009.css",
                widgetcss: _atr + "static/r07/widget119.css",
                widgetIE67css: _atr + "static/r07/widgetIE67006.css",
                widgetpng: "//s7.addthis.com/static/r07/widget059.gif",
                ...
                pinit: _atr + "static/r07/pinit017.html",
                linkedin: _atr + "static/r07/linkedin023.html",
                fbshare: _atr + "static/r07/fbshare004.html",
                tweet: _atr + "static/r07/tweet027.html",
                menujs: _atr + "static/r07/menu162.js",
                sh: _atr + "static/r07/sh152.html"
            }
        };
}(function () {
    var i, q = window,
    ...
    var s = (window.location.protocol == "https:"),
        F, n, y, A = (navigator.userAgent || "unk").toLowerCase(),
        v = (/firefox/.test(A)),
    ...
    if (!window.addthis || window.addthis.nodeType !== i) {
        try {
            F = window.navigator ? (navigator.userLanguage || navigator.language) : "";
            n = F.split("-").pop().toLowerCase();
            y = F.substring(0, 2);
            if (n.length != 2) {
                n = "unk";
            }
        ...
        if (document.location.href.indexOf(_atr) == -1) {
            ...
            function j(a) {
                if (a && !(a.data || {})["addthisxf"] && window.addthis) {
        ...
        setTimeout(function () {
            if (!window.addthis.timer.core) {
                ...
                if (_atc.cdn !== 0) {
                    var d = document.createElement("script");
                    d.type = "text/javascript";
                    d.src = (s ? "https:" : "http:") + _atr + "static/r07/core126.js";
                    h.appendChild(d);
                }
            }
        }, m);
