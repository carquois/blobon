...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Reblog'
        db.create_table('punns_reblog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('origin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['punns.Punn'])),
            ('new_title', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
        ))
        db.send_create_signal('punns', ['Reblog'])


    def backwards(self, orm):
        # Deleting model 'Reblog'
        db.delete_table('punns_reblog')
    ...
    models = {
        ...
        'punns.reblog': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_title': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'}),
