...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cat.top_level_cat'
        db.add_column('punns_cat', 'top_level_cat',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['punns.Cat'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cat.top_level_cat'
        db.delete_column('punns_cat', 'top_level_cat_id')
