...
urlpatterns = patterns('',
    ...
    url(r'^newsubuser/(?P<slug>.*)/$', 'blogs.views.new_subuser'),
    ...
    url(r'^newsubcat/(?P<id>.*)/$', 'blogs.views.add_sub_category'),
    url(r'^addsubcat/(?P<id>.*)/$', 'blogs.views.newcategorysub'),
    ...
    url(r'^(?P<year>\d{4})/$', 'blogs.views.year_archive'),
    url(r'^(?P<year>\d{4})/(?P<month>\d{2})/$', 'blogs.views.month_archive'),
    url(r'^(?P<year>\d{4})/(?P<month>\d{2})/(?P<day>\d{2})/$', 'blogs.views.day_archive'),
    url(r'^viewexpense/(?P<year>\d{4})/$', 'books.views.viewexpense_year'),
    url(r'^viewexpense/(?P<year>\d{4})/(?P<month>\d{2})/$', 'books.views.viewexpense_month'),
    url(r'^viewexpense/(?P<year>\d{4})/(?P<month>\d{2})/(?P<day>\d{2})/$', 'books.views.viewexpense_day'),
    url(r'^createpage/(?P<slug>.*)/$', 'blogs.views.createpage'),
    url(r'^converttag/(?P<id>.*)/$', 'blogs.views.converttag'),
    url(r'^convertcategory/(?P<id>.*)/$', 'blogs.views.convertcategory'),
    ...
    url(r'^publishedcomments/(?P<slug>.*)/$', 'blogs.views.publishedcomments'),
    url(r'^translation/(?P<slug>.*)/$', 'blogs.views.translation'),
    url(r'^quicktranslation/(?P<id>.*)/$', 'blogs.views.quicktranslation'),
    ...
    url(r'^custompost/(?P<slug>.*)/$', 'blogs.views.custom_post'),
    ...
    url(r'^administratemodel/(?P<slug>.*)/(?P<id>.*)/$', 'blogs.views.administratemodel'),
    url(r'^editmodeldata/(?P<slug>.*)/(?P<id>.*)/$', 'blogs.views.editmodeldata'),
    url(r'^deletemodeldata/(?P<slug>.*)/(?P<id>.*)/$', 'blogs.views.deletemodeldata'),
    url(r'^contributors/(?P<slug>.*)/$', 'blogs.views.administratecontributor'),
    url(r'^administratesettings/(?P<slug>.*)/$', 'blogs.views.administratesettings'),
    url(r'^editprofile/$', 'blogs.views.editprofile'),
    url(r'^editcontributor/(?P<id>.*)/(?P<slug>.*)/$', 'blogs.views.editcontributor'),
    url(r'^deletecontributor/(?P<id>.*)/(?P<slug>.*)/$', 'blogs.views.deletecontributor'),
    url(r'^deletecustom/(?P<id>.*)/$', 'blogs.views.deletecustom'),
    url(r'^deletefield/(?P<id>.*)/$', 'blogs.views.deletefield'),
    url(r'^editcustom/(?P<id>.*)/$', 'blogs.views.editcustom'),
    url(r'^adddata/(?P<id>.*)/$', 'blogs.views.adddata'),
    ...
    url(r'^edittag/(?P<id>.*)/$', 'blogs.views.edittag'),
    url(r'^approve/(?P<id>.*)/$', 'blogs.views.approvecomment'),
    url(r'^create/$', 'punns.views.create'),
    url(r'^contactblog/(?P<slug>.*)/$', 'blogs.views.contactblog'),
    ...
    url(r'^cate/(?P<slug>.*)/$', 'punns.views.cat'),
    url(r'^cat/(?P<slug>.*)/$', 'blogs.views.category'),
    url(r'^tag/(?P<slug>.*)/$', 'blogs.views.tag'),
    url(r'^c/(?P<slug>.*)/$', 'blogs.views.category_main'),
    url(r'^a/(?P<username>.*)/$', 'blogs.views.author'),
    url(r'^delete/(?P<id>.*)/$', 'comments.views.delete'),
    url(r'^deleteuser/$', 'blogs.views.deleteuser'),
    ...
    url(r'^deletetag/(?P<id>.*)/$', 'blogs.views.deletetag'),
    ...
    url(r'^deletecommentspending/(?P<slug>.*)/$', 'blogs.views.delete_pending_comments'),
    ...
    url(r'^about/$', direct_to_template, { 'template': 'blogs/about.html' }),
    url(r'^account_deleted/$', direct_to_template, { 'template': 'blogs/account_deleted.html' }),
...
#    url(r'^top/all$', 'punns.views.top'),
    ...
    url(r'^viewexpense/$', 'books.views.viewexpense'),
    url(r'^viewreport/(?P<id>.*)/$', 'books.views.viewreport'),
    url(r'^newreport/$', 'books.views.newreport'),    
