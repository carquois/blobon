...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.twitter_oauth_token'
        db.add_column('accounts_userprofile', 'twitter_oauth_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.twitter_oauth_token_secret'
        db.add_column('accounts_userprofile', 'twitter_oauth_token_secret',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.twitter_oauth_token'
        db.delete_column('accounts_userprofile', 'twitter_oauth_token')

        # Deleting field 'UserProfile.twitter_oauth_token_secret'
        db.delete_column('accounts_userprofile', 'twitter_oauth_token_secret')
