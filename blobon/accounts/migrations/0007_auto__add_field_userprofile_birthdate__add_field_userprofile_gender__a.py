...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'birthdate',
        ...
        # Adding field 'UserProfile.fb_friends'
        db.add_column('accounts_userprofile', 'fb_friends',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.fb_likes'
        db.add_column('accounts_userprofile', 'fb_likes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('accounts_userprofile', 'birthdate')

        # Deleting field 'UserProfile.gender'
        db.delete_column('accounts_userprofile', 'gender')

        # Deleting field 'UserProfile.fb_friends'
        db.delete_column('accounts_userprofile', 'fb_friends')

        # Deleting field 'UserProfile.fb_likes'
        db.delete_column('accounts_userprofile', 'fb_likes')
