...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.main_blog'
        db.add_column('accounts_userprofile', 'main_blog',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogs.Blog'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.main_blog'
        db.delete_column('accounts_userprofile', 'main_blog_id')
