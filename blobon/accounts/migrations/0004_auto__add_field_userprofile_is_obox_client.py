...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_obox_client'
        db.add_column('accounts_userprofile', 'is_obox_client',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_obox_client'
        db.delete_column('accounts_userprofile', 'is_obox_client')
