...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.is_blog_user'
        db.delete_column('accounts_userprofile', 'is_blog_user')

        # Adding field 'UserProfile.is_bloguser'
        db.add_column('accounts_userprofile', 'is_bloguser',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.is_blogadmin'
        db.add_column('accounts_userprofile', 'is_blogadmin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.is_blog_user'
        db.add_column('accounts_userprofile', 'is_blog_user',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UserProfile.is_bloguser'
        db.delete_column('accounts_userprofile', 'is_bloguser')

        # Deleting field 'UserProfile.is_blogadmin'
        db.delete_column('accounts_userprofile', 'is_blogadmin')
    ...
    models = {
        'accounts.userprofile': {
            ...
            'is_blogadmin': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_bloguser': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
