...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_new_from_social'
        db.add_column('accounts_userprofile', 'is_new_from_social',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_new_from_social'
        db.delete_column('accounts_userprofile', 'is_new_from_social')
