                ...
                ping: {
                    ...
                    info: function (b) {
                        if (b) if (b.err) a.f.unThumb(b.id);
                            ...
                            else { if (a.v.scragAllThumbs === true) {
